...
import com.uclee.filter.service.CSRFTokenManager;
import com.uclee.fundation.config.links.ConfigConstant;
import com.uclee.fundation.config.links.GlobalSessionConstant;
import com.uclee.fundation.config.links.Language;
import com.uclee.fundation.config.links.OrderConstant;
import com.uclee.fundation.config.links.PermissionSetting.MarketPermission;
...
import com.uclee.user.util.JavaSmsApi;
...
/*
	...
	public void doLogout(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		if(Strings.isNullOrEmpty(url))
			response.sendRedirect("/uclee-user-web/login");
		else
